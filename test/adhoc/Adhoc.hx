...
*/
        var test:Dynamic;
        test = function (e:Event) {
            trace("frame 1");
            EventDispatcher.removeGlobalEventListener( Event.ENTER_FRAME, test );
        };
        EventDispatcher.addGlobalEventListener( Event.ENTER_FRAME, test );

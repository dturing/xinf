...
class GeometryEvent extends Event<GeometryEvent> {
	...
	static public var IMAGE_LOADED 	   = new EventKind<GeometryEvent>("imageLoaded");
	...
	public function new( _type:EventKind<GeometryEvent>, target:EventDispatcher, _x:Float, _y:Float ) {
		super(_type,target);
		x=_x; y=_y;
	}
}
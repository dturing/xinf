...
class HaxeImplGenerator extends Generator {
	...
	override public function handleFunction( f:ClassField, args:Array<{ name:String, opt:Bool, t:CType, r:TypeRep }>, ret:TypeRep, functionSettings:Settings ) {
		var _this=this;
	...
	public function hxConstructor( f:ClassField, args:Array<{ name:String, opt:Bool, t:CType, r:TypeRep }>, ret:TypeRep ) {
		var _this=this;
	...
	override public function handleStaticVarClass( field:ClassField, className:String ) :Void {
		if( className=="Int" ) {
			globalInts.push( field.name );
		}
	}
	
	override public function handleClass( e:TypeInfos, c:Classdef ) {

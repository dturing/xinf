...
extern class VGU {
	...
	public static function line( path:Path, x0:Float, y0:Float, x1:Float, y1:Float ) :Int;
	/** <nekobind><cptr name="points" type="float" min-size="val_int(n_count)"/></nekobind> **/
	public static function polygon( path:Path, points:String, count:Int, closed:Bool ) :Int;
	public static function rect( path:Path, x:Float, y:Float, width:Float, height:Float ) :Int;
	public static function roundRect( path:Path, x:Float, y:Float, width:Float, height:Float, rx:Float, ry:Float ) :Int;
	public static function ellipse( path:Path, cx:Float, cy:Float, width:Float, height:Float ) :Int;
